...
import OrderHistoryModal from "./OrderHistoryModal"; // 🔴 Import the modal
...
function Navbar() {
  ...
  return (
    <>
            ...
            {isLoggedIn && (
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="bg-orange-50 text-orange-600 px-5 py-2 rounded-xl hover:bg-orange-100 transition-colors shadow-sm"
                >
                  Orders
                </button>
                <button
      ...
      {/* 🔴 Render the Modal if showHistory is true */}
      {showHistory && <OrderHistoryModal closeModal={() => setShowHistory(false)} />}
    </>
  );
}
